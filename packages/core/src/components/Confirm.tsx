...
export function Confirm() {
  ...
  return (
    <div className="ec-fixed ec-inset-0 ec-z-50 ec-bg-primary/50 ec-flex ec-items-center ec-justify-center">
      <div className="ec-bg-primary ec-rounded-lg ec-shadow-lg ec-w-[90%] ec-max-w-[400px] ec-p-4">
        <div className="ec-mb-4">
          {options.title && (
            <h3 className="ec-text-lg ec-font-semibold ec-mb-2">{options.title}</h3>
          )}
          <p className="ec-text-secondary ec-text-xs">{options.description}</p>
        </div>
