...
export const VTab = memo(() => {
  ...
  return (
    <div className="ec-flex ec-flex-col ec-gap-3 ec-pr-2 ec-border-r ec-border-gray-200 ec-h-full ec-select-none">
      {TAB_LIST.map((tab) => (
        <div
          className="ec-flex ec-items-center ec-w-full ec-h-10 ec-bg-gray-100 ec-rounded-lg ec-cursor-pointer ec-hover:ec-bg-gray-200 ec-text-secondary-foreground"
          key={tab.value}
          style={{
      ...
      <div
        className="ec-flex ec-items-center ec-w-fit ec-h-10 ec-bg-gray-100 ec-rounded-lg ec-cursor-pointer ec-hover:ec-bg-gray-200 ec-text-secondary-foreground"
        onClick={() => {
