...
export const Settings = () => {
  ...
  return (
    <div className="ec-fixed ec-inset-0 ec-z-50 ec-w-[800px] ec-h-[500px] ec-bg-white ec-backdrop-blur -ec-translate-x-1/2 -ec-translate-y-1/2 ec-top-1/2 ec-left-1/2 ec-rounded-lg ec-shadow-lg ec-overflow-hidden">
