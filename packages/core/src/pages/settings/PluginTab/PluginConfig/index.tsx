...
export const PluginConfig = memo<Props>(({ plugin }) => {
  ...
  return (
    <>
      ...
      {open && (
        <div className="ec-fixed ec-w-96 ec-max-w-lg ec-max-h-full ec-flex ec-flex-col ec-top-1/2 ec-left-1/2 ec-bg-primary ec-p-4 ec-shadow-lg ec-rounded-lg ec-border ec-border-secondary -ec-translate-x-1/2 -ec-translate-y-1/2">
          {/* 标题 */}
